object FrmSimpleEditor: TFrmSimpleEditor
    ...
    object RichEdtSimple: TRichEdit
      ...
      Lines.Strings = (
        ...
        'RichEdit1'
          ...
          'RichEdit1RichEdit1 RichEdit1RichEdit1RichEdit1RichEdit1 it1Rich ' +
          'it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich ' +
          'it1Rich '
        
          'it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich ' +
          'it1Rich it1Rich it1Rich it1Rich it1Rich'
        ''
        'RichEdit1'
        'RichEdit1'
        'RichEdit1 RichEdit1RichEdit1RichEdit1RichEdit1'
        'RichEdit1'
        ...
        'RichEdit1'
          ...
          'it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich it1Rich ' +
          'it1Rich it1Rich it1Rich it1Rich it1RichRichEdit1'
  ...
  object NiceSetRichEdtSimpl: TNiceSettings
    StoredProps.Strings = (
      'Left'
      'Top'
      'Width'
      'Height'
      'CbBoxFontName.ItemIndex'
      'CbBoxFontSize.Text'
      'ActDivString.Checked')
    RegKey = 'Software\docsoft\Andrology'
    IniFile = 'NiceSetRichEdtSimpl.ini'
    StoreTarget = stRegistry
    Left = 96
    Top = 96
  end
  object AppEventsRichEditSimple: TApplicationEvents
    OnHint = AppEventsRichEditSimpleHint
    OnShortCut = AppEventsRichEditSimpleShortCut
    Left = 128
    Top = 96
  end
end
