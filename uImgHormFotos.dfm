object FrmImgHormFotos: TFrmImgHormFotos
  Left = 216
  Top = 110
  BorderIcons = [biSystemMenu]
  Caption = #1048#1079#1086#1073#1088#1072#1078#1077#1085#1080#1077' '#1073#1083#1072#1085#1082#1072' '#1080#1089#1089#1083#1077#1076#1086#1074#1072#1085#1080#1103' '#1075#1086#1088#1084#1086#1085#1086#1074' '#1082#1088#1086#1074#1080
  ClientHeight = 601
  ClientWidth = 617
  Color = clBtnFace
  ...
  object NiceSetFrmImgHormFotos: TNiceSettings
    StoredProps.Strings = (
      'Left'
      'Top'
      'Width'
  ...
  object AppEventsImgHormFotos: TApplicationEvents
    OnShortCut = AppEventsImgHormFotosShortCut
    Left = 16
    Top = 8
  end
end
