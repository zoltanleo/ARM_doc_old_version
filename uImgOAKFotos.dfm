object FrmImgOAKFotos: TFrmImgOAKFotos
  Left = 216
  Top = 110
  BorderIcons = [biSystemMenu]
  Caption = #1048#1079#1086#1073#1088#1072#1078#1077#1085#1080#1077' '#1073#1083#1072#1085#1082#1072' '#1086#1073#1097#1077#1075#1086' '#1072#1085#1072#1083#1080#1079#1072' '#1082#1088#1086#1074#1080
  ClientHeight = 601
  ClientWidth = 617
  Color = clBtnFace
  ...
  object NiceSetFrmImgOAKFotos: TNiceSettings
    StoredProps.Strings = (
      'Left'
      'Top'
      'Width'
  ...
  object AppEventsImgOAKFotos: TApplicationEvents
    OnShortCut = AppEventsImgOAKFotosShortCut
    Left = 8
    Top = 8
  end
end
