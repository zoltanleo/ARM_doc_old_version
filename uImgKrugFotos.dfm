object FrmImgKrugFotos: TFrmImgKrugFotos
  Left = 216
  Top = 110
  BorderIcons = [biSystemMenu]
  Caption = #1048#1079#1086#1073#1088#1072#1078#1077#1085#1080#1077' '#1073#1083#1072#1085#1082#1072' '#1090#1077#1089#1090#1072' '#1050#1088#1102#1075#1077#1088#1072
  ClientHeight = 601
  ClientWidth = 617
  Color = clBtnFace
  ...
  object NiceSetFrmImgKrugFotos: TNiceSettings
    StoredProps.Strings = (
      'Left'
      'Top'
      'Width'
  ...
  object AppEventsImgKrugFotos: TApplicationEvents
    OnShortCut = AppEventsImgKrugFotosShortCut
    Left = 16
    Top = 8
  end
end
