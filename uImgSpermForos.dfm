object FrmImgSpermFotos: TFrmImgSpermFotos
  Left = 216
  Top = 110
  BorderIcons = [biSystemMenu]
  Caption = #1048#1079#1086#1073#1088#1072#1078#1077#1085#1080#1077' '#1073#1083#1072#1085#1082#1072' '#1089#1087#1077#1088#1084#1086#1075#1088#1072#1084#1084#1099
  ClientHeight = 601
  ClientWidth = 617
  Color = clBtnFace
  ...
  object NiceSetFrmImgSpermFotos: TNiceSettings
    StoredProps.Strings = (
      'Left'
      'Top'
      'Width'
  ...
  object AppEventsImgSpermFotos: TApplicationEvents
    OnShortCut = AppEventsImgSpermFotosShortCut
    Left = 16
    Top = 8
  end
end
