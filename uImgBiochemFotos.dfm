object FrmImgBiochemFotos: TFrmImgBiochemFotos
  Left = 216
  Top = 110
  BorderIcons = [biSystemMenu]
  Caption = #1048#1079#1086#1073#1088#1072#1078#1077#1085#1080#1077' '#1073#1083#1072#1085#1082#1072' '#1073#1080#1086#1093#1080#1084#1080#1095#1077#1089#1082#1086#1075#1086' '#1080#1089#1089#1083#1077#1076#1086#1074#1072#1085#1080#1103' '#1101#1103#1082#1091#1083#1103#1090#1072
  ClientHeight = 601
  ClientWidth = 617
  Color = clBtnFace
  ...
  object NiceSetFrmImgBiochemFotos: TNiceSettings
    StoredProps.Strings = (
      'Left'
      'Top'
      'Width'
  ...
  object AppEventsImgBiochemFotos: TApplicationEvents
    OnShortCut = AppEventsImgBiochemFotosShortCut
    Left = 16
    Top = 8
  end
end
