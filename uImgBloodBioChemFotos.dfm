object FrmImgBloodBioChemFotos: TFrmImgBloodBioChemFotos
  Left = 0
  Top = 0
  ...
  object AppEventsImgBloodBioChemFotos: TApplicationEvents
    OnShortCut = AppEventsImgBloodBioChemFotosShortCut
    Left = 16
    Top = 8
  end
  object NiceSetFrmImgBloodBioChemFotos: TNiceSettings
    StoredProps.Strings = (
      'Left'
      'Top'
      'Width'
